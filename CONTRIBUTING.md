...
```bash
git clone https://github.com/Ionaru/create-package.git
cd create-package
```
...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/create-package.git`.
3. Add the original repository as remote to keep it up-to-date: `git remote add upstream https://github.com/Ionaru/create-package.git`.
